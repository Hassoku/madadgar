                        ...
                        @guest
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('masjid.login') }}">
                                        {{ __('Login As Masjid') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ route('serviceprovider.register') }}">
                                        {{ __('Login As Service Provider') }}
                                    </a>
                            ...
                            @if (Route::has('register'))
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('masjid.register') }}">
                                        {{ __('Register As Masjid') }}
                                    </a>
                                    <a class="dropdown-item" href="{{ route('serviceprovider.register') }}">
                                        {{ __('Register As Service Provider') }}
                                    </a>
