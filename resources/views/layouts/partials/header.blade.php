<header class="stick style1 w-100">
    <div class="topbar bg-color1 d-flex flex-wrap justify-content-center w-100">
        <ul class="topbar-info-list mb-0 list-unstyled d-inline-flex">
            <li><i class="thm-clr flaticon-sun"></i>{{ __('vocab.sunset') }}: <span class="thm-clr">@php echo date_sunrise(time(), SUNFUNCS_RET_STRING, 67.0011, 24.8607, 90, 1).' pm'  @endphp</span></li>
            <li><i class="thm-clr flaticon-moon"></i>{{ __('vocab.sunrise') }}: <span class="thm-clr">7:14pm</span></li>
        </ul>
        ...
        <nav class="d-flex flex-wrap align-items-center justify-content-center">
            <div class="header-left">
                <ul class="mb-0 list-unstyled d-inline-flex">
                    <li><a href="{{route('home')}}">{{__('vocab.home')}}</a></li>
                    ...
                    <li class="menu-item-has-children"><a href="javascript:void(0);" title="">{{ __('vocab.register') }}</a>
                        <ul class="mb-0 list-unstyled">
                        <li><a href="{{ route('register') }}" title="">{{ __('vocab.login_as_donator') }}</a></li>
                            <li><a href="{{ route('serviceprovider.register') }}" title="">{{ __('vocab.login_as_serviceprovider') }}</a></li>
                            <li><a href="{{ route('masjid.register') }}" title="">{{ __('vocab.login_as_imam_masjid') }}</a></li>
                        </ul>
                    </li>
                    @endif
            @else
